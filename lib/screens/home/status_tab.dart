...
///   carousel.
/// - Channels: "Channels" header with an "Explore" pill (find
///   channels). Real followed channels only — until the user follows
///   channels, the reference app's empty-state explainer is shown.
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  // Real followed channels only — no demo/suggestion
                  // tiles. Until the user follows channels, the exact
                  // reference-app empty state is shown.
                  Padding(
                    padding: const EdgeInsets.fromLTRB(20, 0, 20, 8),
                    child: Text(
