      ...
      body: ListView(
        ...
        children: [
          ...
          _linkTile(
            ...
            title: 'GDPR Privacy Policy (EU)',
            card: card,
            textPrimary: textPrimary,
            textSecondary: textSecondary,
            textMuted: textMuted,
            border: border,
            onTap: () => _launchUrl(KoraApi.gdprPrivacyPolicyUrl),
          ),
          _linkTile(
            context,
            icon: Icons.add_circle_outline,
            title: 'Supplemental Terms & Privacy',
            card: card,
            textPrimary: textPrimary,
            textSecondary: textSecondary,
            textMuted: textMuted,
            border: border,
            onTap: () => _launchUrl(KoraApi.supplementalTermsUrl),
          ),
          _linkTile(
            context,
            icon: Icons.campaign_outlined,
            title: 'Channels Guidelines',
            card: card,
            textPrimary: textPrimary,
            textSecondary: textSecondary,
            textMuted: textMuted,
            border: border,
            onTap: () => _launchUrl(KoraApi.channelsGuidelinesUrl),
          ),
          _linkTile(
            context,
            icon: Icons.face_retouching_natural_outlined,
            title: 'Face & Hands Effects Privacy',
            card: card,
            textPrimary: textPrimary,
            textSecondary: textSecondary,
            textMuted: textMuted,
            border: border,
            onTap: () => _launchUrl(KoraApi.faceHandsEffectsUrl),
          ),
          _linkTile(
            context,
            ...
            textMuted: textMuted,
            border: border,
            onTap: () => _launchUrl(KoraApi.blockingAndReportingUrl),
          ),
          _linkTile(
            context,
            ...
            textMuted: textMuted,
            border: border,
            onTap: () => _launchUrl(KoraApi.premiumTermsUrl),
          ),
          _linkTile(
            context,
            ...
            textMuted: textMuted,
            border: border,
            onTap: () => _launchUrl(KoraApi.accountDeletionPolicyUrl),
          ),
          const SizedBox(height: 20),
